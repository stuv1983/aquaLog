...
def validate_reading(param: str, value: float) -> None:
    ...
    Raises:
        ValueError: If value is outside plausible range
    """
...
def is_out_of_range(
    ...
    *, 
    ...
    Args:
        ...
        tank_id: ID of the tank being checked
        ph: Current pH (needed for ammonia calculation)
        temp_c: Current temperature in °C (needed for ammonia calculation)
        
    Returns:
        True if value is out of safe range, False otherwise
    """
