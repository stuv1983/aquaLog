def warnings_tab() -> None:
    ...
    for _, row in df.iterrows():
        ...
        # Then check standard parameters from the allowed list
        allowed_params = ["ph", "temperature", "nitrite", "nitrate", "kh", "gh"]
